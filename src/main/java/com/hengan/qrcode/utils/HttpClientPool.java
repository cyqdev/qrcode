...
public class HttpClientPool {
	...
	public static HttpEntity httpPost(String url, Map<String, Object> headers,
		...
		try {
			...
			httpPost.setEntity(new StringEntity(data, ContentType.create(
	 ...
	 * 使用表单键值对传参
	 */
	public static HttpEntity PostForm(String url, Map<String, Object> headers,
	...
	private static HttpRequest setHeaders(Map<String, Object> headers,
			HttpRequest request) {
